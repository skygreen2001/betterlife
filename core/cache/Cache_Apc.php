 ...
 *      apc.user_ttl = 0
 *      apc.write_lock = On
 * @see 下载:http://downloads.php.net/pierre/  <br/>
 * @see 下载[php5.2:http://downloads.php.net/pierre/php_apc-3.1.5-5.2-vc6-x86.zip]   <br/>
 * @see 在Windows里安装APC:http://docs.moodle.org/20/en/Installing_APC_in_Windows    <br/>
 * @see Problems with APC setup and apache2 errors:http://serverfault.com/questions/278530/problems-with-apc-setup-and-apache2-errors
 +---------------------------------
 * @category betterlife
 * @package core.cache
 * @author skygreen
