        ...
        if ( file_exists(self::$filename_config_xml) )
        {
            ...
            if ( $dataobjects ) {
                foreach ($dataobjects as $dataobject) {
                    ...
                    self::$filter_fieldnames[$classname] = $conditions;
                    ...
                    if ( !empty($relation_viewfield_obj) ) {
                        ...
                        self::$relation_viewfield[$classname] = $relation_viewfields;
                    }
                    ...
                    if ( !empty($redundancy_table_field_obj) ) {
                        ...
                        self::$redundancy_table_fields[$classname] = $redundancy_table_fields;
                    }
