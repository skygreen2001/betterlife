...
{block name=body}
    ...
    <div class="contentBox" >
        ...
        <form name="postForm" method="POST">
            博文名:<br/>
            <input type="text" class="inputNormal" style="width:100%;" name="blog_name" value="{$blog.blog_name}"/><br/><br/>
            内容: <br/>
            <textarea id="blog_content" name="blog_content" style="width:100%; height:300px;">{$blog.blog_content}</textarea><br/>
