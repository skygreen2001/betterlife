...
<div class="block">
    ...
    <table class="viewdoblock">
        ...
        <tr class="entry">
            ...
            <td class="content">{$blogtags.blog.blog_name}</td>
            <td class="content">{$blogtags.blog_id}</td>
            <td class="content">{$blogtags.tags.title}</td>
    ...
    <div class="page-control-bar" align="center"><my:page src='{$url_base}index.php?go=model.blogtags.lists' /></div>
