...
{block name=body}
    ...
    <div class="block">
        ...
        <table class="viewdoblock">
            ...
            <tr class="entry"><th class="head">预算</th><td class="content"><input type="number" class="edit" name="budget" value="{$department.budget}"/></td></tr>
            <tr class="entry"><th class="head">实际开销</th><td class="content"><input type="number" class="edit" name="actualexpenses" value="{$department.actualexpenses}"/></td></tr>
            <tr class="entry"><th class="head">预估平均工资</th><td class="content"><input type="number" class="edit" name="estsalary" value="{$department.estsalary}"/></td></tr>
            <tr class="entry"><th class="head">实际工资</th><td class="content"><input type="number" class="edit" name="actualsalary" value="{$department.actualsalary}"/></td></tr>
