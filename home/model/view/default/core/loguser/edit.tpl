...
{block name=body}
    ...
    {/if}
     <div class="block">
        ...
        <tr class="entry"><th class="head">日志详情</th>
            <td class="content">
                <textarea id="log_content" name="log_content" style="width:90%;height:300px;">{$loguser.log_content}</textarea>
            </td>
        </tr>
