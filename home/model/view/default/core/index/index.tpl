...
{block name=body}
    <div><h1>这是首页列表(共计数据对象18个)</h1></div>
    <table class="viewdoblock" style="width: 500px;">
        ...
        <tr class="entry"><td class="content"><a href="{$url_base}index.php?go=model.admin.lists">系统管理人员</a></td></tr>
        ...
        <tr class="entry"><td class="content"><a href="{$url_base}index.php?go=model.rolefunctions.lists">角色拥有功能</a></td></tr>
