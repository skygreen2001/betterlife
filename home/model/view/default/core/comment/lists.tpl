...
<div class="block">
    ...
    <table class="viewdoblock">
        ...
        <tr class="entry">
            ...
            <td class="content">{$comment.user.username}</td>
            <td class="content">{$comment.user_id}</td>
            <td class="content">{$comment.comment}</td>
            <td class="content">{$comment.blog.blog_name}</td>
    ...
    <div class="page-control-bar" align="center"><my:page src='{$url_base}index.php?go=model.comment.lists' /></div>
