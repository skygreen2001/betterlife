...
{block name=body}
    ...
    {/if}
     <div class="block">
        ...
        <tr class="entry"><th class="head">图标</th><td class="content"><input type="file" class="edit" name="icon_urlUpload" accept="image/png,image/gif,image/jpg,image/jpeg" value="{$category.icon_url}"/></td></tr>
        ...
        <tr class="entry"><th class="head">说明</th>
            <td class="content">
                <textarea id="intro" name="intro" style="width:90%;height:300px;">{$category.intro}</textarea>
            </td>
        </tr>
