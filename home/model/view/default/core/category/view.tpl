...
<div class="block">
    ...
    <table class="viewdoblock">
        ...
        <tr class="entry"><th class="head">图标</th><td class="content">
            <div class="wrap_2_inner"><img src="{$uploadImg_url|cat:$category.icon_url}" alt="图标"></div>
            <br/>存储相对路径:{$category.icon_url}</td></tr>
